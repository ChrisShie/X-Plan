    ...
    <div>
        <div class="row">
            <div class="col-md-12">
                ...
                <button class="btn btn-border-cyan" @click="open=true">Add City</button>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                 <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(city, index) in cities.slice((currentPage-1)*10, 10*currentPage)">
                            ...
                            <td>{{city.name}}</td>
                            <td>{{city.description|truncate(120) }}</td>
                            <td>
        ...
        <div class="row">
            <div class="col-md-12">
                 <uiv-pagination class="pull-right" v-model="currentPage" :total-page="totalPage" @change="changePage"/>
            </div>
        </div>
        <uiv-modal v-model="open" title="Add New City" ref="modal" id="modal-add" :footer="false" @hide="reset">
    ...
    methods: {
        ...
        getAllCities(){
            axios.get('/city').then(response => {
                ...
                this.totalPage = Math.ceil(this.cities.length/10);
            });
        },
        openEditCity(id){
            var vm=this;
